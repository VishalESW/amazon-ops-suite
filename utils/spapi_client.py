...
class SpApiClient:
    ...
    def fetch_sqp(self, asins, weeks=8):
        ...
        # align end to the last completed Saturday (Amazon SQP weeks are Sun–Sat)
        end -= timedelta(days=(end.weekday() + 1) % 7 or 7)  # back up to a Saturday
